define([], )
var Video = Backbone.Model.extend({ urlRoot:"localhost:3000/videos"});
...
var ThumbnailListView = Backbone.View.extend({
  ...
  initialize: function() {
      _(this).bindAll('add', 'remove', 'reset', 'select', 'resize', 
...
var AppView = Backbone.View.extend({
  ...
  initialize: function() {
      this.template = _.template($('.container-list').html());
